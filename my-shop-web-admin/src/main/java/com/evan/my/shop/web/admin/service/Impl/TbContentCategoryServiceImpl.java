package com.evan.my.shop.web.admin.service.Impl;

import com.evan.my.shop.commons.dto.BaseResult;
import com.evan.my.shop.commons.validator.BeanValidator;
import com.evan.my.shop.domain.TbContentCategory;
import com.evan.my.shop.web.admin.abstracts.AbstractBaseTreeServiceImpl;
import com.evan.my.shop.web.admin.dao.TbContentCategoryDao;
import com.evan.my.shop.web.admin.service.TbContentCategoryService;
...
public class TbContentCategoryServiceImpl extends AbstractBaseTreeServiceImpl<TbContentCategory, TbContentCategoryDao> implements TbContentCategoryService {
     ...
     * 保存分类
     *
     * @param entity {@link TbContentCategory}
     * @return
     */
    @Override
